...
def descriptive_analysis(list_jsonl: str):
    ...
    print(f'Total number: {len(prodigy_data)}, rejected: {prodigy_data.nr_rejected}')
...
def main():
    list_jsonl = [
        ...
        'data/iaa/iaa_round1_50/iaa_resolution/prodigy_export_review_all_text_50_20240418_review_20240607_145354.jsonl',
